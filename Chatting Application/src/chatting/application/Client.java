...
public class Client implements ActionListener{
    ...
    Client(){
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/sukuna.png"));
    ...
    public static void main(String[] args){
        ...
        try{
            //Creating socket and connecting it to the sever by providng the localhost and port number
            Socket socket = new Socket("127.0.0.1", 8080);
            
            DataInputStream Incomingdata = new DataInputStream(socket.getInputStream()); 
            Outgoingdata = new DataOutputStream(socket.getOutputStream());
